...
#pragma mark Sandbox Crenditials
    ...
    //    txnParam.key = @"kYz2vV";
    //    txnParam.merchantid = @"6773686";
    //    self.payu_salt = @"zhoXe53j";
    
//    txnParam.environment = PUMEnvironmentTest;
//    txnParam.key = @"6TsK9kaI";
//    txnParam.merchantid = @"6773686";
//    self.payu_salt = @"Twb7XPbHtZ";
    
    
    txnParam.environment = PUMEnvironmentTest;
    txnParam.key = @"rjQUPktU";
    txnParam.merchantid = @"4934580";
    self.payu_salt = @"e5iIg1jwi8";
